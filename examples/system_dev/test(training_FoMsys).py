...
inputList = [ ('DATA', 'e_d'), ('DATA', 'sigma'), ('DATA', 'w'), ('DATA', 'eta')]
...
if __name__ == "__main__":
    ...
    data = buildInputs(ASPECT_list, None, 'data/FoM_generatedData_15Jun15.csv', False,        #training data set
    ...
    test_name = 'TEST IN DATA - SYS: In:7-2 Out:9-2   DATA: In:2 Out:2'
    outForm = 'gauss'
    inDataForm = 'gauss'
    outDataForm = 'gauss'
    nRand = 10
    ...
    """
    trainData = copy.deepcopy(data[:400])
    valData = copy.deepcopy(data[400:500])
    ...
    test_name = 'SYS: In:5-2 Out:9-2   DATA: In:2 Out:2'
    outForm = 'gauss'
    inDataForm = 'sing'
    outDataForm = 'gauss'
    ...
    """
    test_name = 'SYS: In:5-2 Out:9-2   DATA: In:3 Out:3'
    outForm = 'gauss'
    inDataForm = 'tri'
    outDataForm = 'tri'
    testMFs(trainData, valData, test_name, inMFs, outMFs, outForm, inDataForm, outDataForm)
    ...
    test_name = 'SYS: In:5-2 Out:9-2   DATA: In:4 Out:4'
    outForm = 'gauss'
    inDataForm = 'trap'
    outDataForm = 'trap'
    testMFs(trainData, valData, test_name, inMFs, outMFs, outForm, inDataForm, outDataForm)    
    ...
    test_name = 'SYS: In:5-3 Out:9-3   DATA: In:2 Out:2'
    outForm = 'tri'
    inDataForm = 'gauss'
    outDataForm = 'gauss'
    testMFs(trainData, valData, test_name, inMFs, outMFs, outForm, inDataForm, outDataForm)
    
    test_name = 'SYS: In:5-3 Out:9-3   DATA: In:3 Out:3'
    outForm = 'tri'
    inDataForm = 'tri'
    outDataForm = 'tri'
    testMFs(trainData, valData, test_name, inMFs, outMFs, outForm, inDataForm, outDataForm)
    
    test_name = 'SYS: In:5-3 Out:9-3   DATA: In:4 Out:4'
    outForm = 'tri'
    inDataForm = 'trap'
    outDataForm = 'trap'
    testMFs(trainData, valData, test_name, inMFs, outMFs, outForm, inDataForm, outDataForm)    
    ...
    inMFs = input_5trapMFs       
    outMFs = output_9trapMFs
    
    test_name = 'SYS: In:5-4 Out:9-4   DATA: In:2 Out:2'
    outForm = 'trap'
    inDataForm = 'gauss'
    outDataForm = 'gauss'
    testMFs(trainData, valData, test_name, inMFs, outMFs, outForm, inDataForm, outDataForm)
    
    test_name = 'SYS: In:5-4 Out:9-4   DATA: In:3 Out:3'
    outForm = 'trap'
    inDataForm = 'tri'
    outDataForm = 'tri'
    testMFs(trainData, valData, test_name, inMFs, outMFs, outForm, inDataForm, outDataForm)
    
    test_name = 'SYS: In:5-4 Out:9-4   DATA: In:4 Out:4'
    outForm = 'trap'
    inDataForm = 'trap'
    outDataForm = 'trap'
    testMFs(trainData, valData, test_name, inMFs, outMFs, outForm, inDataForm, outDataForm)          
